...
class TESTFFMPEGC():
    def __init__(self):
        ...
        self.camera_config = {
            ...
            "camera": "localhost",
            "camera_id": int("1"),
            "logdir":"D:\Rohit\Sudisa\safety\paintshop\paintshopproject\paintai\logs",
            "imgdir":"D:\Rohit\Sudisa\safety\paintshop\paintshopproject\paintai\imgs",
            "alarm_type": "Warning",
    ...
    def enqueue_frame_buffer(self):
        ...
        while True:
            try:
                ...
                self.logger.info(self.width * self.height * 3)
                self.logger.info(Frame is not None)
